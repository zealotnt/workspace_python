# -*- coding: utf-8 -*-
# [Ref](http://www.rkblog.rk.edu.pl/w/p/webkit-pyqt-rendering-web-pages/)
# To generate ui code: type `pyuic4 httpWidget.ui > httpWidget.py`
# To run application: type `python run.py`
